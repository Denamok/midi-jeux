...
<?php if($plxShow->plxMotor->plxRecord_arts->f('allow_com') AND $plxShow->plxMotor->aConf['allow_com']): ?>
	...
	<form id="contact-form" action="<?php $plxShow->artUrl(); ?>#form" method="post">
		<fieldset>
			<div class="grid">
				<div class="col sml-12">
					<label class="name" for="id_name"><?php $plxShow->lang('NAME') ?> :</label>
					<input id="id_name" name="name" type="text" size="20" value="<?php $plxShow->comGet('name',''); ?>" maxlength="30" />
				</div>
			</div>
			<div class="grid">
				<div class="col sml-12 lrg-6">
					<label class="name" for="id_mail"><?php $plxShow->lang('EMAIL') ?> :</label>
					<input id="id_mail" name="mail" type="text" size="20" value="<?php $plxShow->comGet('mail',''); ?>" />
				</div>
				<div class="col sml-12 lrg-6">
					<label class="name" for="id_site"><?php $plxShow->lang('WEBSITE') ?> :</label>
			...
			<div class="grid">
				<div class="col sml-12">
					...
					<label class="name" for="id_content" class="message"><?php $plxShow->lang('COMMENT') ?> :</label>
...
<br>
			...
			<div class="grid">
				<div class="buttons-wrapper">
					...
					<input class="btn btn-1" type="submit" value="<?php $plxShow->lang('SEND') ?>" />
				</div>
			</div>
		</fieldset>
	</form>
